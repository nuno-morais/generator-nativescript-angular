...
module.exports = class extends Generator {
  ...
  prompting() {
    ...
    this.log(yosay(
      'Welcome to the awe-inspiring ' + chalk.red('generator-ng-nativescript') + ' generator!'
    ));
  ...
  writing() {
    ...
    this.fs.copy(
      this.templatePath('AngularBehavior.txt'),
      this.destinationPath(`${componentName}Behavior.ts`),
